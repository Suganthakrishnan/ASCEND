    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.forgotBtn} onPress={() => Alert.alert('SYSTEM', 'Password reset coming soon.')}>
            <Text style={styles.forgotText}>FORGOT ACCESS CODE?</Text>
          </TouchableOpacity>

          <Button title="ENTER SYSTEM" onPress={handleSignIn} isLoading={isLoading} style={styles.primaryBtn} />
          ...
          <TouchableOpacity style={styles.googleBtn} onPress={handleGoogleStub} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  logoSub: { fontSize: 9, color: theme.colors.textDimmed, letterSpacing: 2, marginTop: theme.spacing.xs },
  ...
  orText: { color: theme.colors.textDimmed, fontSize: 12, letterSpacing: 2 },
  googleBtn: {
